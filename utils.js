...
module.exports = {
    ...
    search(search, msg) {
        ...
        if (!member) guild.members.find(user => `${user.username.toLowerCase()}#${user.discriminator}` === search.toLowerCase() || user.username.toLowerCase() === search.toLowerCase() || (!user.nick && user.nick.toLowerCase() === search.toLowerCase()));
